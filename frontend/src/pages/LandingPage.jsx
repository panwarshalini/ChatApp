        ...
        >
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text color="gray.500" fontSize="xl">
              Experience the future of group communication. ConnectFlow offers a modern, real-time chat platform for teams, friends, and communities, enhanced with smart features like typing indicators and online status to keep conversations seamless and engaging.
            </Text>
            <Stack
              spacing={{ base: 4, sm: 6 }}
            ...
            >
              ...
              >
                <HStack justify="space-between">
                  <HStack>
                    <Icon as={FiUsers} />
                    <Text fontWeight="bold">Code & Coffee</Text>
                  </HStack>
                  <HStack spacing={4}>
              ...
              >
                <ChatMessage
  sender="Priya Sharma"
  message="Hey team! Just wrapped up the new UI components. Pushing to dev now."
  time="10:30 AM"
  isUser={false}
/>
<ChatMessage
  sender="Rahul Desai"
  message="Awesome work, Priya! Eager to see how they look live. 🙌"
  time="10:31 AM"
  isUser={false}
/>
<ChatMessage
  sender="You"
  message="Sounds good! Will pull the changes and test them out. Coffee break soon?"
  time="10:32 AM"
  isUser={true}
/>
